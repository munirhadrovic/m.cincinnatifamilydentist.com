<?php
	$adresa="8284 Beechmont Avenue Cincinnati,OH 45255"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5132311012;// Broj koji se poziva na dugme CALL US
